...
case class SmoothVelocityStream(
  /* The number of data points in this stream */
  original_size: Option[Int] = None,
  /* The level of detail (sampling) in which this stream was returned */
  resolution: Option[SmoothVelocityStreamEnums.Resolution] = None,
  /* The base series used in the case the stream was downsampled */
  series_type: Option[SmoothVelocityStreamEnums.SeriesType] = None,
  /* The sequence of velocity values for this stream, in meters per second */
  data: Option[Seq[Float]] = None
)

object SmoothVelocityStreamEnums {
