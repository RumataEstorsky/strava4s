...
case class SmoothGradeStream(
  /* The number of data points in this stream */
  original_size: Option[Int] = None,
  /* The level of detail (sampling) in which this stream was returned */
  resolution: Option[SmoothGradeStreamEnums.Resolution] = None,
  /* The base series used in the case the stream was downsampled */
  series_type: Option[SmoothGradeStreamEnums.SeriesType] = None,
  /* The sequence of grade values for this stream, as percents of a grade */
  data: Option[Seq[Float]] = None
)

object SmoothGradeStreamEnums {
