...
case class MovingStream(
  ...
  resolution: Option[MovingStreamEnums.Resolution] = None,
  /* The base series used in the case the stream was downsampled */
  series_type: Option[MovingStreamEnums.SeriesType] = None,
  /* The sequence of moving values for this stream, as boolean values */
  data: Option[Seq[Boolean]] = None
)

object MovingStreamEnums {
